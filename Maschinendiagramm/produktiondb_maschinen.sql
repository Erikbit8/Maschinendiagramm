...
CREATE TABLE `maschinen` (
  `idMaschinen` int NOT NULL AUTO_INCREMENT,
  `Maschinen` varchar(45) NOT NULL,
  PRIMARY KEY (`idMaschinen`)
...
INSERT INTO `maschinen` VALUES (1,'Machine1'),(2,'Maschine2'),(3,'Maschine3');
